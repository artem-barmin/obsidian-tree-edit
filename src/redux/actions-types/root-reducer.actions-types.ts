...
import { ADD_CARD_VERTICALLY, CREATE_EMPTY_CARD } from '../types/root-reducer.types';
...
export type AddCardRight = IAction<typeof ADD_CARD, RootInterfaces.IAddCard>;

export type AddCardVertically = IAction<typeof ADD_CARD_VERTICALLY, RootInterfaces.IAddCard>;
