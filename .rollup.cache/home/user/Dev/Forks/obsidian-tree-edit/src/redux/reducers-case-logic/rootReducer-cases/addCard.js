...
const addNewCardToNeighbors = ({ inputState, selectedId, newCardId, cardIndexInDepth, allNeighbors, chainNeighbors = [], }) => {
...
const addNewCardToParents = ({ inputState, allParents, newCardId, selectedDepth, lastNeighborId, }) => {
...
export const addCard = (state, { whereToAdd, contentHTML, markdownContent }) => {
